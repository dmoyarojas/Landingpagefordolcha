      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-12 items-center py-32">
        ...
        <div className="hidden lg:flex justify-center">
          <div
            ...
            style={{ width: 340, height: 440, boxShadow: "0 30px 80px rgba(0,0,0,0.35)" }}
          >
            <img
              src="https://images.unsplash.com/photo-1581745071812-e69f8cf9e898?w=680&h=880&fit=crop&auto=format"
